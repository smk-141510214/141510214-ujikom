        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-success">
				...
				{!! Form::model($pegawai, ['class' => 'form-horizontal',  'enctype' => 'multipart/form-data', 'method' => 'PATCH', 'route' => ['pegawai.update', $pegawai->id], 'files' => true]) !!}
                    ...
                    <label for="poto" class="col-md-4 control-label">Photo</label>
                        <div class="col-md-6">
                            <input id="poto" type="file" name="poto" value="{{ old('poto') }}"><br><img src="{{asset('/image/'.$data->poto)}}" height="100px" width="150px"><br><br>
                        </div>
