            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group{{ $errors->has('kode_tunjangan_pegawai') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="kode_tunjangan_pegawai" type="text" class="form-control" name="kode_tunjangan_pegawai" value="{{ old('kode_tunjangan_pegawai') }}" required autofocus>

                            @if ($errors->has('kode_tunjangan_pegawai'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('kode_tunjangan_pegawai') }}</strong>
                                </span>
                            @endif
                        </div>
                    </div><br>
